...
AWaypoint::AWaypoint()
{
	...
	BoxComponent->OnComponentBeginOverlap.AddDynamic(this, &AWaypoint::OnPlayerEnter);// & is used as a refererence to the function
...
{
	AAI_Guard_Character* Player = nullptr;
	if (OtherActor != nullptr) {
		Player = Cast<AAI_Guard_Character>(OtherActor);
		if (Player != nullptr) {
