...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AGillie_Statics::NewProp_CameraBoom_MetaData[] = {
		{ "Category", "Camera" },
		{ "Comment", "// making the camera boom\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Gillie.h" },
		{ "ToolTip", "making the camera boom" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AGillie_Statics::NewProp_FollowCamera_MetaData[] = {
		{ "Category", "Camera" },
		{ "Comment", "// * means that it is a type of SpringArm and the U means it will be picked up by GB collection..\n// camera Follows the player\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Gillie.h" },
		{ "ToolTip", "* means that it is a type of SpringArm and the U means it will be picked up by GB collection..\ncamera Follows the player" },
	};
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AGillie_Statics::NewProp_SprintSpeedMultiplier_MetaData[] = {
		{ "Category", "Character Movement: Walking" },
		{ "ModuleRelativePath", "Gillie.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AGillie_Statics::NewProp_SprintSpeedMultiplier = { "SprintSpeedMultiplier", nullptr, (EPropertyFlags)0x0010000000020015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGillie, SprintSpeedMultiplier), METADATA_PARAMS(Z_Construct_UClass_AGillie_Statics::NewProp_SprintSpeedMultiplier_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AGillie_Statics::NewProp_SprintSpeedMultiplier_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AGillie_Statics::NewProp_WalkSpeed_MetaData[] = {
		{ "Category", "Character Movement: Walking" },
		{ "ModuleRelativePath", "Gillie.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AGillie_Statics::NewProp_WalkSpeed = { "WalkSpeed", nullptr, (EPropertyFlags)0x0010000000020015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGillie, WalkSpeed), METADATA_PARAMS(Z_Construct_UClass_AGillie_Statics::NewProp_WalkSpeed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AGillie_Statics::NewProp_WalkSpeed_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AGillie_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AGillie_Statics::NewProp_SprintSpeedMultiplier,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AGillie_Statics::NewProp_WalkSpeed,
	};
	...
	IMPLEMENT_CLASS(AGillie, 2125388384);
